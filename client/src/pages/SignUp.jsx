    ...
    <div className="min-h-screen bg-[#2D4966]">
      ...
      <div className="flex mb-24 gap-5 p-3 max-w-3xl mx-auto flex-col md:flex-row md:items-center">
        ...
        <div className="p-10 flex-1 ">
          ...
          <p className="text-white py-4 mt-5 px-6"> At BB Architecture, we believe in the transformative power of design. From concept to creation, we are dedicated to bringing your vision to life, ensuring every detail reflects your unique story and aspirations</p>
           </Link>
        </div>
        {/* right div */}
        <div className="text-white mx-8 flex-1">
          <form action="" className="flex flex-col gap-4 ">
            <div className="flex flex-col ">
              <label htmlFor="" className="font-bold py-1">Username</label>
